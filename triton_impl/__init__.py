...
from .swa_sink_ascend_bwd import (                     # NPU-shaped (1-D grid) backward + autograd op
    swa_sink_bwd_ascend, swa_sink_attn_ascend, dense_sink_attn_ascend,
)
...
__all__ = [
    ...
    "swa_sink_attn_ascend", "dense_sink_attn_ascend",
]
